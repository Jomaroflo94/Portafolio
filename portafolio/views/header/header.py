...
def header(profile, media_list, is_mobile: bool) -> rx.Component:
    return rx.cond(
        is_mobile,
...
def header_desktop(profile, media_list) -> rx.Component:
    return rx.center(
        rx.hstack(
...
def header_mobile(profile, media_list) -> rx.Component:
    return rx.vstack(
        rx.hstack(
